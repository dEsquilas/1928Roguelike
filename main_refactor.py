...
class Game(arcade.Window):
    def __init__(self):
        ...
        map_name2 = "./assets/scenarios/default2.tmx"

        layer_options = {
        }

        self.tile_map1 = arcade.load_tilemap(map_name, TILE_SCALING, layer_options)
        self.tile_map2 = arcade.load_tilemap(map_name2, TILE_SCALING, layer_options)
    ...
    def setup(self):
        ...
        self.room = arcade.Scene.from_tilemap(self.tile_map)
        ...
        self.sounds["bullet"] = arcade.load_sound("assets/sounds/bullet.wav")
